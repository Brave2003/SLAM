...
// ------------------------------------------------------------------------------------------
    ...
    void ORBextractor::DetectAndCompute( InputArray _image, InputArray _mask, vector<KeyPoint>& _keypoints,
...
// ----------------------------------------------------------------------
    ...
    void ORBextractor::ScreenAndComputeKPsParams( InputArray _image, std::vector<KeyPoint>& _keypoints,
